    ...
    <div className="flex-1 overflow-y-auto flex flex-col bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-lg p-1 shadow-sm">
       ...
       <div className="text-center p-4 border-t border-light-border dark:border-dark-border bg-light-card dark:bg-dark-card rounded-b-lg">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <button onClick={onDownloadReport} className="bg-white dark:bg-dark-card text-slate-700 dark:text-slate-200 font-semibold py-2 px-6 rounded-md border border-slate-300 dark:border-dark-border hover:bg-slate-50 dark:hover:bg-slate-700 transition-all duration-300 flex items-center justify-center gap-2">
